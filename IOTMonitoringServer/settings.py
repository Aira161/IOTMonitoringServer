...
ALLOWED_HOSTS = ["localhost", "54.165.86.75", "54.175.211.118"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "34.229.200.63",  # Dirección IP del servidor de la base de datos
        "PORT": "5432",
        "OPTIONS": {
            "sslmode": "disable",
        },
...
MQTT_HOST = "54.175.211.118"  # "ip.maquina.mqtt"
